		...
		<div class="container">
			<article <?php post_class( 'single-post' ); ?>>
				...
				<div class="blog-post__layout">
					...
					<div class="blog-post__content entry-content article-content longcopy" data-reveal><?php echo wp_kses_post( $content ); ?></div>
				</div>
