...
function teznevise_recommended_pages() {
	return array(
		...
		'service-qualitative' => array(
			'title'    => 'تحلیل کیفی',
			'template' => 'page-service.php',
			'meta'     => array(
				'eyebrow'       => 'خدمات پژوهشی',
				'subtitle'      => 'تحلیل مضمون و روش‌های کیفی',
				'service_icon'  => 'fa-solid fa-comments',
				'service_color' => 'icon-indigo',
				'cta_text'      => 'شروع مشاوره رایگان',
				'cta_url'       => '/inquiry/',
			),
		...
		'service-project' => array(
			...
			'meta'     => array(
				'eyebrow'       => 'خدمات پژوهشی',
				'subtitle'      => 'پروژه‌های درسی و کارورزی',
				'service_icon'  => 'fa-solid fa-folder-open',
				'service_color' => 'icon-teal',
				'cta_text'      => 'شروع مشاوره رایگان',
				'cta_url'       => '/inquiry/',
			),
		...
		'service-article' => array(
			...
			'meta'     => array(
				'eyebrow'       => 'خدمات پژوهشی',
				'subtitle'      => 'نگارش و استخراج مقاله علمی',
				'service_icon'  => 'fa-solid fa-newspaper',
				'service_color' => 'icon-cyan',
				'cta_text'      => 'شروع مشاوره رایگان',
				'cta_url'       => '/inquiry/',
			),
