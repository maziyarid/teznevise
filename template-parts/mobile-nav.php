...
?>
<div class="mobile-nav" data-mobile-menu role="dialog" aria-label="<?php esc_attr_e( 'منوی موبایل', 'teznevise' ); ?>">
	<div class="mobile-nav-panel">
		...
		<div class="mobile-nav-links">
			...
			<a class="mobile-nav-link" href="<?php echo esc_url( home_url( '/service-thesis/' ) ); ?>">
				<i class="fa-solid fa-graduation-cap" aria-hidden="true"></i> <?php esc_html_e( 'انجام پایان‌نامه', 'teznevise' ); ?>
			</a>
		...
		<div class="mobile-nav-cta">
			...
			<a class="btn-tz btn-outline-tz" href="<?php echo esc_url( teznevise_get_contact( 'whatsapp' ) ); ?>">
				<i class="fa-brands fa-whatsapp" aria-hidden="true"></i> <?php esc_html_e( 'گفتگو در واتساپ', 'teznevise' ); ?>
			</a>
		</div>
	</div>
</div>
