...
function teznevise_enqueue_assets() {
	...
	$nav_js_resolved = teznevise_resolve_asset( 'assets/js/nav-dropdown.js' );
	if ( $nav_js_resolved ) {
		wp_enqueue_script( 'teznevise-nav-dropdown', $nav_js_resolved['url'], array( 'teznevise-main' ), $nav_js_resolved['ver'], true );
	}
}
