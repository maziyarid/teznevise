...
define( 'TEZNEVISE_VERSION', '1.9.31' );
...
require_once TEZNEVISE_DIR . '/inc/seo-regressions.php';
...
/* The migrator is mutation-heavy and belongs only in admin/WP-CLI requests. */
...
// header.php and footer.php never fatal-error on a missing symbol.
...
/** Keep obsolete callers from fatalling; parity styles live in runtime CSS. */
