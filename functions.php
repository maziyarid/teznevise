...
define( TEZNEVISE_VERSION, 1.9.24 );
...
require_once TEZNEVISE_DIR . /inc/api.php;
...
// Defensive fallback: this repos functions.php has repeatedly lost this
...
function teznevise_enqueue_assets() {
	// Enqueue core CSS files only (consolidated from 50+ hotfix files)
	wp_enqueue_style( teznevise-tokens, TEZNEVISE_URI . /assets/css/tokens.css, array(), TEZNEVISE_VERSION );
	wp_enqueue_style( teznevise-base, TEZNEVISE_URI . /assets/css/base.css, array( teznevise-tokens ), TEZNEVISE_VERSION );
	wp_enqueue_style( teznevise-responsive, TEZNEVISE_URI . /assets/css/responsive.css, array( teznevise-base ), TEZNEVISE_VERSION );
