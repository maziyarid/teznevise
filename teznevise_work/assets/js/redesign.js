document.addEventListener('DOMContentLoaded', function () {
  ...
  // Close mobile menu on in-page anchor clicks
  ...
  // Progressive disclosure for SEO copy
  ...
  // ---- Animated counters for reason-stats ----
  ...
  document.querySelectorAll('.reason-stats').forEach((stats) => {
    const items = stats.querySelectorAll('div > b');
    items.forEach((b) => {
