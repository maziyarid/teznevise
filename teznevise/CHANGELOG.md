...
- Demote embedded H1 headings and namespace editor DOM IDs so pages keep one H1 and do not duplicate IDs.
...
- Restrict public REST user enumeration, harden browser headers, rate-limit lead/AI submissions, remove raw IP persistence, validate AI provider hosts/models, and stop exposing chain-of-thought fields.
