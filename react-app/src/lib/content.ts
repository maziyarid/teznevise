...
export const PROPOSAL_CONSEQUENCES = [
	{
		title: "اتلاف وقت",
		text: "بعد از ۶ ماه ممکن است متوجه شوید نتایج قابل‌دفاع نیستند؛ مثلاً در موضوعی که ماهیت علّی دارد از پژوهش همبستگی استفاده شده و باید برگردید و پروپوزال را از نو اصلاح کنید.",
	},
	{
		title: "اتلاف بودجه",
		text: "روشی که نمونه آماری بزرگ یا طرح طولی پرهزینه می‌طلبد، یا فرضیه‌ای که قابل آزمون نیست و ابزار ندارد، هزینه و زمان زیادی روی دست شما می‌گذارد.",
	},
	{
