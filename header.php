...
<div class="nav-actions">
	...
	<div class="nav-quick-actions desktop-cta-group">
		<a class="nav-cta nav-cta-outline" href="<?php echo esc_url( teznevise_page_url_from_candidates( array( 'about-us', 'about', 'our-story' ), '/about-us/' ) ); ?>"><i class="fa-regular fa-circle-question" aria-hidden="true"></i><span><?php esc_html_e( 'درباره ما', 'teznevise' ); ?></span></a>
