...
<header class="site-header-new">
	...
	<nav class="main-nav" aria-label="<?php esc_attr_e( 'منوی اصلی', 'teznevise' ); ?>">
		...
		<div class="nav-actions">
			<button type="button" class="nav-search-btn" aria-label="<?php esc_attr_e( 'جستجو', 'teznevise' ); ?>" data-search-open><i class="fa-solid fa-magnifying-glass" aria-hidden="true"></i></button>
		...
		<button type="button" class="menu-btn" aria-label="<?php esc_attr_e( 'باز کردن منو', 'teznevise' ); ?>" aria-expanded="false" data-menu-toggle><i class="fa-solid fa-bars" data-menu-icon aria-hidden="true"></i></button>
	</nav>
</header>
