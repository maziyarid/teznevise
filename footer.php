<?php
/**
 * Theme footer — structure matches teznevise_work/*.html
 *
 * @package Teznevise
 */
?>
...
<footer class="footer-new">
	<div class="container">
		<div class="footer-grid">
			<div class="footer-brand">
				<a class="footer-logo" href="<?php echo esc_url( home_url( '/' ) ); ?>">
					...
					if ( $logo_url ) {
						printf(
							'<img src="%s" alt="%s" width="120" height="58" loading="lazy">',
							esc_url( $logo_url ),
		...
		<div class="footer-bottom">
			...
			<span><?php esc_html_e( 'طراحی RTL واکنش‌گرا', 'teznevise' ); ?></span>
		</div>
	</div>
</footer>
